...
h27 = uicontrol(...
    ...
    'Position',[60 22.0117647058823 c_width*4 c_height],...
    'BackgroundColor',[1 1 1],...
    'Callback',blanks(0),...
    'Children',[],...
...
h29 = uicontrol(...
    ...
    'String','RE',...
    'Style','text',...
    'Position',[60+c_width*3.9 22.0117647058823 c_width*2 c_height],...
    'BackgroundColor',[1 1 1],...
    'Children',[],...
...
h30 = uicontrol(...
    ...
    'String',' GUI',...
    'Style','text',...
    'Position',[60+c_width*5.9 22.0117647058823 c_width*4 c_height],...
    'BackgroundColor',[1 1 1],...
    'Children',[],...
    'ForegroundColor',get(0,'defaultuicontrolForegroundColor'),...
    'ParentMode','manual',...
