...
uicontrol(tabId, 'Style','pushbutton','String','Save project','Units','normalized','Position',[0.01 0.02 .15 .05], 'Callback',{@save_settings} );
uicontrol(tabId, 'Style','pushbutton','String','Reset form','Units','normalized','Position',[0.17 0.02 .15 .05], 'Callback',{@reset_settings} );
    ...
    function project_properties(panel_id, modifiable)
        ...
        try
            ...
            handles.project_folder = uicontrol(panel_id,'Style','edit',...
                ...
                'HorizontalAlignment', 'left',...
                'Units','normalized','Position',[spc*3+dwidth top-num*dheight dwidth*2 dheight/2]);
            
            uicontrol(panel_id,'Style','text',...
                'String','*',...
                'HorizontalAlignment', 'left','BackgroundColor', special_color,...
                'Units','normalized','Position',[spc*3.3+dwidth*3 top-num*dheight spc dheight/2]);
            
            
            %if(strcmp(modifiable,'On'))
            handles.project_folder_button = uicontrol(panel_id,'Style','pushbutton',...
                'String', 'Select...',...
                'Units','normalized','Position',[spc*5+dwidth*3 top-num*dheight dwidth/2 dheight/2],...
            ...
            handles.project_description = uicontrol(panel_id,'Style','edit',...
                ...
                'HorizontalAlignment', 'left',...
                'Max',3,'Min',0,...
                'Units','normalized','Position',[spc*3+dwidth top-(num+1)*dheight dwidth*2 dheight*1.5]);
            ...
            button_stochastic = uicontrol(handles.model_type,'Style',...
                ...
                'String','stochastic',...
                'Tag', '1',...
                'Units','normalized','Position',[spc*4 0.5 0.8 0.5],...
                'BackgroundColor', special_color,...
            ...
            button_deterministic =  uicontrol(handles.model_type,'Style','radiobutton',...
                ...
                'Tag', '0',...
                'Units','normalized','Position',[spc*4 0 0.8 0.5],...
                'BackgroundColor', special_color,...
                'HandleVisibility','off');
            ...
            uicontrol(panel_id,'Style','text',...
                ...
                'HorizontalAlignment', 'left','BackgroundColor', special_color,...
                'Units','normalized','Position',[spc*3+dwidth top-num*dheight dwidth dheight/2]);%[width+h_space top-v_space*6 width*2 v_size] );
            
            num = num+1;
            handles.bg = uibuttongroup(panel_id,'Visible','off',...
                'Units','normalized','Position',[spc*3+dwidth top-num*dheight dwidth dheight],...%[width+h_space top-v_space*7.5 width*2 3.5] ,...
                'BackgroundColor', special_color,...
            ...
            button_always = uicontrol(handles.bg,'Style',...
                ...
                'Tag', '1',...
                'Units','normalized','Position',[spc*4 0.5 0.8 0.5],...%[3 1.5 width*2 v_size],...
                'BackgroundColor', special_color,...
                'HandleVisibility','off');
            ...
            button_never =  uicontrol(handles.bg,'Style','radiobutton',...
                ...
                'Tag', '0',...
                'Units','normalized','Position',[spc*4 0 0.8 0.5],...%[3 0 width*2 v_size],...
                'BackgroundColor', special_color,...
                'HandleVisibility','off');
