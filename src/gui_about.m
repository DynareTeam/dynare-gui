...
uicontrol(panel, 'style', 'text', 'FontSize', fsize, 'Units', 'normalized', ...
    'String', termOfUseStr, ...',...
    'Position', [0.15 0.3 0.7 0.5], 'HorizontalAlignment', 'center', ...
        'BackgroundColor', special_color, 'enable', 'inactive');

uicontrol(tabId, 'Style', 'pushbutton', 'String', 'OK', 'Units', 'normalized', ...
          'Position', [0.5-gui_size.button_width/2 gui_size.bottom ...
                    gui_size.button_width gui_size.button_height], ...
          'HorizontalAlignment', 'center', 'Callback', {@close_tab,tabId});
