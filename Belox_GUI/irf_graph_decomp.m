function []=irf_graph_decomp(z,var_names,endo_names, shock_name)
...
for j=1:nvar
    ...
    title(sprintf('IRF decomposition of %s on: %s (%s)', getShockName(shock_name), getVariableName(var_name),var_name));
