    ...
    function uipanelResults_CreateFcn()
        ...
        uicontrol( ...
         ...
         handles.parameterSet = uicontrol( ...
            ...
            'Style', 'popupmenu', ...
            'Units', 'characters', ...
            'Position', [lo+17 r_top-1.5 20 1.5], ...
        ...
        handles.firstPeriodQuarter = uicontrol( ...
            ...
            'Style', 'popupmenu', ...
            'Units', 'characters', ...
            'Position', [lo+42 r_top-1.5 10 1.5], ...
        ...
        handles.firstPeriodYear = uicontrol( ...
            ...
            'Style', 'popupmenu', ...
            'Units', 'characters', ...
            'Position', [lo+54 r_top-1.5 10 1.5], ...
        ...
        handles.lastPeriodQuarter = uicontrol( ...
            ...
            'Style', 'popupmenu', ...
            'Units', 'characters', ...
            'Position', [lo+42 r_top-3.5 10 1.5], ...
        ...
        handles.lastPeriodYear = uicontrol( ...
            ...
            'Style', 'popupmenu', ...
            'Units', 'characters', ...
            'Position', [lo+54 r_top-3.5 10 1.5], ...
